...
from networksecurity.entity.config_entity import TrainingPipelineConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig
    ...
    def start_data_transfromation(self,data_validation_artifact:DataValidationArtifact):
        ...
        try:
            ...
            data_transformation=DataTransformation(data_validation_artifact=data_validation_artifact,
                                                   data_validation_config=data_transformation_config)
            data_transfromation_artifact=data_transformation.intiate_data_transformation()
